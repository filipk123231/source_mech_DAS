...
def get_source_mech(files, dev, eqlon, eqlat, eqdepth, output_folder, pathToEqNet='/home/a/EQNet/predict.py', workers=-1, model=None, ignorePicksStartSec=5, ignorePicksEndSec=10, topN_median=30, rakeRangeMin=-90, rakeRangeMax=90):
    ...
    sp_ratio_source_mech.source_mech(files=files, dev=dev, output_folder=output_folder, ignorePicksStartSec=ignorePicksStartSec, ignorePicksEndSec=ignorePicksEndSec, workers=workers, topN_median=topN_median, rakeRangeMin=rakeRangeMin, rakeRangeMax=rakeRangeMax)